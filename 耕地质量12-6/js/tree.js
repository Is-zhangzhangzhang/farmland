...
* @Last Modified time: 2017-11-28 15:50:03
*/
...
function getType(year)
{
    ...
    .done(function(type) {
        $("#select-type").html('<option selected="true" disabled="true" value="0">请选择</option>');
...
function getProv(year,type)
{
    ...
    .done(function(prov) {
        //console.log("success");
        $("#select-prov").html('<option selected="true" disabled="true" value="0">请选择</option>');
